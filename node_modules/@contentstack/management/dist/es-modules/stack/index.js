...
export function Stack(http, data) {
  ...
  if (data && data.stack && data.stack.api_key) {
    ...
    this.globalField = function () {
      ...
      var api_version = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '3.0';
      var data = {
        stackHeaders: _this.stackHeaders,
        // eslint-disable-next-line camelcase
     ...
     *
     */
    this.settings = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee4() {
      var response;
     ...
     *
     */
    this.resetSettings = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee5() {
      var response;
     ...
     *
     */
    this.addSettings = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee6() {
      var stackVariables,
        response,
        _args6 = arguments;
      return _regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            stackVariables = _args6.length > 0 && _args6[0] !== undefined ? _args6[0] : {};
            _context6.prev = 1;
            _context6.next = 4;
            return http.post("".concat(_this.urlPath, "/settings"), {
              stack_settings: {
          ...
          case 4:
            ...
            return _context6.abrupt("return", response.data.stack_settings);
          case 9:
     ...
     *
     */
    this.share = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee7() {
      var emails,
        roles,
        response,
        _args7 = arguments;
      ...
      var _ref8 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee8(email) {
        ...
        return _regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 8:
              return _context8.abrupt("return", error(response));
            case 9:
              _context8.next = 14;
              break;
            case 11:
