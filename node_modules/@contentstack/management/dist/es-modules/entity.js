    ...
    return _regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          headers = {
            headers: _objectSpread({}, cloneDeep(stackHeaders)),
...
export var query = function query(_ref10) {
...
function _get() {
  _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee11(http, url, params, data) {
    var headers, response;
...
export var move = function move(http, type) {
  ...
  return /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee10() {
    ...
    return _regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          param = _args10.length > 0 && _args10[0] !== undefined ? _args10[0] : {};
          _context10.prev = 1;
          updateData = {};
          json = cloneDeep(this);
          ...
          _context10.next = 10;
          return http.put("".concat(this.urlPath, "/move"), updateData, headers);
        case 10:
          ...
          return _context10.abrupt("return", new this.constructor(http, parseData(response, this.stackHeaders, this.content_type_uid, this.taxonomy_uid, http)));
        case 15:
          throw error(response);
        case 16:
          _context10.next = 21;
...
export function cleanAssets(data) {
  if (data && _typeof(data) === 'object') {
    ...
    for (var _i = 0, _keys = keys; _i < _keys.length; _i++) {
      var key = _keys[_i];
      if (data[key] !== null && data[key] !== undefined && _typeof(data[key]) === 'object') {
        if (isAsset(data[key])) {
