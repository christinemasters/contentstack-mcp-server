...
function Organization(http, data) {
  ...
  if (data && data.organization) {
     ...
     */
    this.teams = function () {
      var teamUid = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      data.organizationUid = _this.uid;
      if (teamUid) {
        data.uid = teamUid;
      }
      return new _teams.Teams(http, data);
    };
    /**
        ...
        return _regenerator2["default"].wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return http.post("".concat(_this.urlPath, "/transfer-ownership"), {
                transfer_to: email
              });
            case 3:
    ...
    this.app = function () {
      ...
      return new _app.App(http, uid !== null ? {
        data: {
          uid: uid,
          organization_uid: _this.uid
        }
      } : {
        organization_uid: _this.uid
      });
    ...
    /**
        ...
        *
        */
    this.appRequest = function () {
      return new _request.AppRequest(http, {
        organization_uid: _this.organization_uid
      }, _this.params);
    };
  } else {
    /**
